...
/**
 * Provides the local service interface for RegisterOfFarmers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RegisterOfFarmersLocalServiceUtil
...
public interface RegisterOfFarmersLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link RegisterOfFarmersLocalServiceUtil} to access the register of farmers local service. Add custom service methods to {@link com.test.service.impl.RegisterOfFarmersLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
